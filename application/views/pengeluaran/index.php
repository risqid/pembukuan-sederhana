            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header card-header-primary">
                        ...
                        <p class="card-category">Kelola data pengeluaran toko</p>
                    </div>
                    <div class="card-body">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input name="keluar" type="number" class="form-control" placeholder="masukkan nominal" required>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    foreach ($pengeluaran as $p) : ?>
                                        <tr>
                                            ...
                                            <td class="text-danger">
                                                Rp.<?= number_format($p['keluar'], 0, ',', '.'); ?>
                                            </td>
                                            <td class="td-actions">
                                                <button type="button" class="btn btn-warning btn-link btn-sm" data-toggle="modal" data-target="#modalEdit" data-id="<?= $p['id'] ?>" data-tanggal="<?= $p['tanggal'] ?>" data-kategori="<?= $p['kategori'] ?>" data-catatan="<?= $p['catatan'] ?>" data-keluar="<?= $p['keluar'] ?>" onclick="loadEditData(this)">
                                                    <i class="material-icons">edit</i>
                                                </button>
                                                <a href="<?= base_url('pengeluaran/delete/') . $p['id']; ?>" onclick="return confirm('apakah anda yakin ingin menghapus?')">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input name="keluar" type="number" class="form-control" placeholder="masukkan nominal" autofocus required>
                                                </div>
                                            </div>
...
<script>
    function loadEditData(baris) {
        ...
        var keluar = baris.getAttribute("data-keluar");
        ...
        document.edit.keluar.value = keluar;
    }
    ...
    //     document.input.keluar.value = jumlah * harga;
    // }
</script>